...
def main():
    ...
    desired_theta1 = generate_joint_trajectory(start_theta1, target_theta1, frames)
    desired_theta2 = generate_joint_trajectory(start_theta2, target_theta2, frames)
    ...
    desired_path = calculate_end_effector_path(desired_theta1, desired_theta2)
    ...
    cartesian_results = analyse_cartesian_tracking(desired_path, actual_path)

    print("\nControlled Robot Cartesian Tracking Results")
    print(f"Target position: ({target_x:.3f}, {target_y:.3f})")
    print(f"Target joint angles: θ1={target_theta1:.2f}°, θ2={target_theta2:.2f}°")
